...
file(APPEND ${PROJECT_SOURCE_DIR}/cmake/generated/${PROJECT_NAME}Config.cmake "if(NOT hapticdevice_FOUND)\n")
...
file(APPEND ${PROJECT_SOURCE_DIR}/cmake/generated/${PROJECT_NAME}Config.cmake "    set(hapticdevice_FOUND TRUE)\n")
